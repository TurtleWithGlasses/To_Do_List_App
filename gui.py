...
add_button = sg.Button(size=20,image_source="C:\\Users\\mhmts\\PycharmProjects\\To_Do_List_App\\add.png", mouseover_colors="gray",
                       tooltip="Add Todo", key="Add")
list_box = sg.Listbox(values=to_do_functions.get_todos(), key="todos", enable_events=True, size=[45, 10])
edit_button = sg.Button("Edit")
complete_button = sg.Button(size=20,image_source="C:\\Users\\mhmts\\PycharmProjects\\To_Do_List_App\\complete.png", mouseover_colors="gray",
